          ...
          <main className="px-4 sm:px-6 md:px-4">
            <div id="about" className="pt-12 text-gray-900 dark:text-white">
              <div className="grid grid-cols-3 grid-rows-3">
                ...
                <div className="mt-6 min-[443px]:mt-3 min-[456px]:mt-0 col-span-3 2xs:mt-10 2xs:col-span-2 2xs:col-start-2 2xs:px-7 xs:px-0 sm:col-span-3 sm:-mt-[4.5rem]">
            ...
            <div id="skills" className="mt-16 sm:-mt-32 h-72 font-josefin-sans text-md text-gray-900 dark:text-white">
