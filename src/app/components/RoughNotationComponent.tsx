    ...
    return (
        <div className="font-josefin-slab font-semibold tracking-wide">
            <RoughNotationGroup show={true}>
                ...
                <RoughNotation animationDelay={5000} type="circle" color={`${props.isDarkMode ? 'grey' : 'red'}`} order="1">
                    <span style={{ whiteSpace: 'nowrap' }}>self-starter</span>
                </RoughNotation>

                <p className="inline"> with an aptitude for </p>

                <RoughNotation animationDelay={5000} type="underline" color={`${props.isDarkMode ? 'grey' : 'red'}`} order="2">
                ...
                <RoughNotation animationDelay={5000} type="underline" color={`${props.isDarkMode ? 'grey' : 'red'}`} order="3">
                    <span style={{ whiteSpace: 'nowrap' }}>technologies</span>
                </RoughNotation>

                <p className="inline"> to build pixel-perfect </p>

                <RoughNotation animationDelay={5000} type="underline" color={`${props.isDarkMode ? 'grey' : 'red'}`} order="4">
                ...
                <RoughNotation animationDelay={5000} type="box" color={`${props.isDarkMode ? 'grey' : 'red'}`} order="5">
